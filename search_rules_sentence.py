            ...
            try:
                with open(filepath, 'r', encoding='utf-8', errors='ignore') as file:
                    ...
                    for i, line in enumerate(lines):
                        # Check if the entire sentence (keyword) is in the line
                        if keyword in line:
...
if __name__ == "__main__":
    ...
    directory = r"C:\Users\Admin\OneDrive - Subex Limited\Documents\Kali_shared\sectriolabupdates\Threat_Intelligence_Updates\Rules"
